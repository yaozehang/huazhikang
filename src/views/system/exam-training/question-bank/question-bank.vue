<template>
  <div class="main-content">
   ...
   <!-- 新增/编辑弹出框 -->
        <!-- 新增弹出框  -->
    <div class="del-form" :visible.sync="showFlag">
     <el-dialog  class="dialog-form" :title="editType===0?'新增试题':'编辑试题'" width="840px"  :visible.sync="showFlag" :closeOnClickModal ="false">
        <el-form :inline="true" :model="editParams"  ref="editParams"  :rules="rules" class="demo-form-inline" label-width="120px" style="">
          <div class="form-items">
          <el-form-item label="主题名称"  class="inner-group" prop="themeName"  required>
            <el-select v-model="editParams.themeId" @change="changeTheme"  placeholder="请选择"  class="inner-input">
             <el-option v-for="item in themeOptions" :key="item.id" :label="item.theme" :value="item.id"></el-option>
            </el-select>
            </el-form-item>
            <el-form-item label="正确答案"   class="inner-group"  prop="answer"  required>
           ...
           <div class="form-items">
            <el-form-item label="是否启用"  class="inner-group">
              <el-select v-model="editParams.status" placeholder="请选择"  class="inner-input">
             <el-option v-for="item in statusOptions" :key="item.value" :label="item.label" :value="item.value"></el-option>
         </el-select>
            </el-form-item>
            <el-form-item label="得分" prop="score"  required  class="inner-group">
              <el-input v-model="editParams.score" class="inner-input"></el-input>
            </el-form-item>
          </div>
          <div class="form-items">
            <el-form-item label="题干名称"  class="input-group large"  prop="stem"  required >
          ...
          <div class="form-items">
            <el-form-item label="选项A"  class="input-group large"  prop="optionA"  required>
          ...
          <div class="form-items">
            <el-form-item label="选项B"  class="input-group large"  prop="optionB"  required>
          ...
          <div class="form-items">
            <el-form-item label="选项C"  class="input-group large"  prop="optionC"  required>
          ...
          <div class="form-items">
            <el-form-item label="选项D"  class="input-group large"  prop="optionD"  required>
          ...
          <div class="form-items ">
            <el-form-item  class="special-group">
  ...
  data () {
    return {
      ...
      rules: {
        ...
        answer: [{ required: true, message: '正確答案不能為空', trigger: 'blur' }],
        score:[{ required: true, message: '考试得分不能为空', trigger: 'blur' }],
        stem:[{ required: true, message: '考试题干不能为空', trigger: 'blur' }],
        optionA:[{ required: true, message: '选项A不能为空', trigger: 'blur' }],
        option:[{ required: true, message: '选项B干不能为空', trigger: 'blur' }],
        optionC:[{ required: true, message: '选项C干不能为空', trigger: 'blur' }],
        optionD:[{ required: true, message: '选项D干不能为空', trigger: 'blur' }],
      },
    }
  },
  created() {
