<template>
  <!-- 6-3.历次职业健康检查结果及处理情况  id 22 -->
<div class="content">
  <div class="list-title-all border-bottom">
     <button class="title-btn-file">历次职业健康检查结果及处理情况 </button>
  </div>
  <div class="tableForm">                 
  ...
  <div class="my-table" >
    ...
    <tbody>
       <tr>
        ...
        <th style="width:100px;">  检查种类 </th>
        <th style="width:100px;">  检查结论</th>
        <th style="width:100px;"> 检查机构 </th>
        <th style="width:100px;">  岗位 </th>
        <th style="width:100px;"> 人员处理情况 </th>
        <th style="width:100px;"> 本人签字 </th>
        <th style="width:100px;"> 现场处理情况 </th>
      ...
      <tr v-for="(i, x) in tableData " :key="x" track-by="x">
       <td  > <input v-model="i[0]" >  </input> </td>
        ...
        <tr colspan="9" style="height:40px;line-height:40px; text-align: center;  position: relative;" >
          <td class="center-td" colspan="9"> <i class="el-icon-circle-plus-outline add-btn" @click="addRow"></i> </td>
       </tr>
    </tbody>
   </table>
  </div>
