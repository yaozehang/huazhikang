<template>
  <!-- 6.2．工作场所职业病危害因素检测结果  id 38-->
<div class="content">
  <div class="list-title-all border-bottom">
     <button class="title-btn-file">工作场所职业病危害因素检测结果 </button>
  </div>
  <div class="tableForm">                 
  ...
  <div class="my-table" >
    ...
    <tbody>
       <tr>
        ...
        <th style="width:100px;">  检测时间 </th>
        <th style="width:100px;">  检测机构</th>
        <th style="width:150px;"> 职业病害因素名称 </th>
        <th style="width:250px;">  职业病危害因素检测结果 </th>
        <th style="width:100px;"> 防护措施 </th>
      ...
      <tr v-for="(i, x) in tableData " :key="x" track-by="x">
       <td > <input v-model="i[0]" >  </input> </td>
        ...
        <tr colspan="8" style="height:40px;line-height:40px; text-align: center;  position: relative;" >
          <td class="center-td" colspan="8"><i class="el-icon-circle-plus-outline add-btn" @click="addRow"></i></td>
       </tr>
    </tbody>
   </table>
  </div>
