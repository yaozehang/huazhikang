...
<div class="content">
  <div class="list-title-all border-bottom">
     <button class="title-btn-file">职业病患者一览表 </button>
  </div>
  ...
  <div class="my-table" >
    ...
    <tbody>
       <tr>
        ...
        <th style="width:100px;">  接害工龄 </th>
        <th style="width:100px;"> 车间岗位 </th>
        <th style="width:100px;"> 职业病名 </th>
        <th style="width:100px;"> 诊断机构 </th>
        <th style="width:100px;"> 诊断日期 </th>
      ...
      <tr v-for="(i, x) in tableData " :key="x" track-by="x">
       <td > <input v-model="i[0]" >  </input> </td>
        ...
        <tr colspan="12" style="height:40px;line-height:40px; text-align: center;  position: relative;" >
          <td class="center-td" colspan="12"><i class="el-icon-circle-plus-outline add-btn" @click="addRow"></i></td>
       </tr>
    </tbody>
   </table>
  </div>
