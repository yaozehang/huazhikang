...
<div class="content">
  <div class="list-title-all border-bottom">
     <button class="title-btn-file">工作场所警示标识一览表</button>
  </div>
  <div class="tableForm">
  ...
  <div class="my-table" >
    ...
    <tbody>
       <tr>
        ...
        <th style="width:100px;"> 作业区 </th>
        <th style="width:200px;"> 告知项目 </th>
        <th style="width:200px;"> 配置地点 </th>
        <th style="width:100px;"> 警示内容 </th>
        <th style="width:100px;"> 标识数量</th>
