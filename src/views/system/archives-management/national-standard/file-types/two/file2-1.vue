...
<div class="content">
  <div class="list-title-all border-bottom">
     <button class="title-btn-file">职业病防治计划实施检查表</button>
  </div>
  <form action="" ref="myform">
  <div class="tableForm">
    <el-form :inline="true"  class="demo-form-inline file-form" label-width="160px" >
  ...
  <div class="my-table" >
    ...
    <tbody>
       <tr>
        ...
        <th style="width:200px;">  职业病防治计划内容 </th>
        <th style="width:200px;"> 实施情况</th>
        <th style="width:200px;"> 实施负责人 </th>
