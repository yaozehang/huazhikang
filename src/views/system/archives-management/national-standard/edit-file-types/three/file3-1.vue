...
<div class="content">
  ...
  <div class="tableForm">                 
    <el-form :inline="true" :model="form1" class="demo-form-inline" label-width="140px" style="margin-left:-50px;">
      ...
      <div class="form-items">
        <el-form-item label="组织部门"  style="margin-right:30px;">
        ...
        <el-form-item label="实施日期">
          <el-date-picker v-model="form[10]"  value-format="yyyy-MM-dd" type="date" placeholder="选择日期" style="width:220px;"> </el-date-picker>
        </el-form-item>
      </div>
       <div class="form-items">
        <el-form-item label="培训内容"  style="margin-right:30px;">
  ...
  <div class="my-table" >
    <table >
    <tbody>
      <tr>   <td colspan="6">签到表</td>   </tr>
       <tr>
        <th style="width:270px;">  序号 </th>
        <th style="width:400px;"> 部门</th>
        <th style="width:400px;">  成绩</th>
        <th style="width:400px;"> 姓名（签字） </th>
      ...
      <tr v-for="(i, x) in tableData " :key="x" track-by="x">
        ...
        <tr colspan="6" style="height:40px;line-height:40px; text-align: center;  position: relative;" >
