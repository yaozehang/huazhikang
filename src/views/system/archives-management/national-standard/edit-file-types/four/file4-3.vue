...
<div class="content">
  <div class="list-title-all border-bottom">
     <el-button class="title-btn" type="text">职业病危害因素日常监测季报汇总表 </el-button>
  </div>
  <div class="tableForm">                 
  ...
  <div class="my-table" >
    ...
    <tbody>
       <tr>
        <th style="width:170px;">  车   间 </th>
        <th style="width:300px;"> 职业病危害因素名称</th>
        <th style="width:280px;">  监测周期 </th>
        <th style="width:200px;">  监测点数</th>
        <th style="width:210px;"> 监测结果范围 </th>
        <th style="width:200px;">  合格率(%) </th>
        <th style="width:210px;"> 职业接触限值 </th>
        <th style="width:200px;">  监测人员 </th>
