...
<div class="content">
  <div class="list-title-all border-bottom">
     <el-button class="title-btn" type="text">职业病患者一览表 </el-button>
  </div>
<form ref="myform" action="">
  <div class="tableForm">                 
    <el-form :inline="true"  ref="form2" class="demo-form-inline" label-width="140px" style="margin-left:-50px;">
  ...
  <div class="my-table" >
    ...
    <tbody>
       <tr>
        ...
        <th style="width:250px;">  接害工龄 </th>
        <th style="width:210px;"> 车间岗位 </th>
        <th style="width:210px;"> 职业病名 </th>
        <th style="width:280px;"> 诊断机构 </th>
        <th style="width:200px;"> 诊断日期 </th>
        <th style="width:200px;"> 处理情况 </th>
