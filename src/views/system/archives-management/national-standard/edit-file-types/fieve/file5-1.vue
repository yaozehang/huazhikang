<template>
   <div class="content">
   	<table-title :title="'可能产生职业病危害设备、材料和化学品一览'"></table-title>
    ...
    <div class="form-table-container">
    	<ul class="form-container">
    		...
    		<li class='input-group'>
    			...
    			<el-date-picker type="date" placeholder="选择日期" v-model="form[6]" value-format="yyyy-MM-dd" classs="inner-input"></el-date-picker>
    		</li>
    	</ul>
    	<div class="table-container my-table">
    		 <table width="100%">
              ...
              <tr>
                ...
                <td > <el-input v-model="i[0]" >  </el-input> </td>
                <td ><el-input v-model="i[1]" >  </el-input> </td>
                <td ><el-input v-model="i[2] " >  </el-input></td>
                <td ><el-input v-model="i[3] " >  </el-input> </td>
                <td > <el-input v-model="i[4]" >  </el-input> </td>
                <td ><el-input v-model="i[5]" >  </el-input> </td>
                <td ><el-input v-model="i[6]" >  </el-input> </td>
                <td ><el-input v-model="i[7]" >  </el-input> </td>
                <td ><el-input v-model="i[8]" >  </el-input> </td>
                <td ><el-input v-model="i[9]" >  </el-input> </td>
                <td ><el-input v-model="i[10]" >  </el-input> </td>
                <td ><el-input v-model="i[11]" >  </el-input> </td>
