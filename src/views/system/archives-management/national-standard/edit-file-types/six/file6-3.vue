...
<div class="content">
  <div class="list-title-all border-bottom">
     <el-button class="title-btn" type="text">历次职业健康检查结果及处理情况 </el-button>
  </div>
  <div class="tableForm">                 
  ...
  <div class="my-table" >
    ...
    <tbody>
       <tr>
        <th style="width:120px;"> 检查日期</th>
        <th style="width:100px;">  检查种类 </th>
        <th style="width:300px;">  检查结论</th>
        <th style="width:280px;"> 检查机构 </th>
        <th style="width:250px;">  岗位 </th>
        <th style="width:310px;"> 人员处理情况 </th>
        <th style="width:280px;"> 本人签字 </th>
        <th style="width:280px;"> 现场处理情况 </th>
