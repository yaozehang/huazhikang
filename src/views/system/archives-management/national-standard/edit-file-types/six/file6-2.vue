...
<div class="content">
  <div class="list-title-all border-bottom">
     <el-button class="title-btn" type="text">工作场所职业病危害因素检测结果 </el-button>
  </div>
  <div class="tableForm">                 
  ...
  <div class="my-table" >
    ...
    <tbody>
       <tr>
        ...
        <th style="width:200px;">  检测机构</th>
        <th style="width:280px;"> 职业病害因素名称 </th>
        <th style="width:350px;">  职业病危害因素检测结果 </th>
        <th style="width:310px;"> 防护措施 </th>
