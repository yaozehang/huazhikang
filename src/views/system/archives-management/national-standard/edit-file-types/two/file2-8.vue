...
<div class="content">
  <div class="list-title-all border-bottom">
     <el-button class="title-btn" type="text">用人单位职业卫生检查和处理记录表  </el-button>
  </div>
  <div class="tableForm">
    <el-form :inline="true" :model="form1" class="demo-form-inline" label-width="150px" style="margin-left:-10px;">
       ...
       <div class="form-items">
        ...
        <el-form-item label="车间负责人">
         ...
         <el-form-item label="检查时间">
            <el-date-picker v-model="form[7]" type="date" value-format="yyyy-MM-dd" placeholder="选择日期" style="width:220px;"> </el-date-picker>
        </el-form-item>
      </div>
      <div class="form-items clearfix">
        <div class="word-left">
          <p class="findQusetion">
            ...
            <el-form-item label="检查人员" label-width="80px">
              <el-input v-model="form[8]" placeholder="" style="width:220px;"></el-input>
            </el-form-item>
            <el-form-item label="日期" label-width="80px">
              <el-date-picker v-model="form[9]" type="date" value-format="yyyy-MM-dd" placeholder="选择日期" style="width:220px;"> </el-date-picker>
             </el-form-item>
          </p>
          <el-form-item label=""  >
      ...
      <div class="form-items">
         <p class="findQusetion">
            ...
            <el-form-item label="车间负责人" label-width="90px">
              <el-input v-model="form[14]" placeholder="" style="width:220px;"></el-input>
            </el-form-item>
            <el-form-item label="日期" label-width="80px">
              <el-date-picker v-model="form[15]" type="date" value-format="yyyy-MM-dd" placeholder="选择日期" style="width:220px;"> </el-date-picker>
             </el-form-item>
          </p>
        <el-form-item label=""  >
          <el-input v-model="form[16]" placeholder="" type="textarea" :rows="5" 
