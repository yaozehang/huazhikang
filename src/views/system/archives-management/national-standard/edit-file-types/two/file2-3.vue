...
<div class="content">
  ...
  <div class="my-table" >
    ...
    <tbody>
       <tr>
        <th style="width:80px;">  车间名称 </th>
        <th style="width:400px;"> 接触职业病危害因素 </th>
        <th style="width:400px;">  个人防护用品名称 </th>
        <th style="width:400px;"> 型号</th>
        <th style="width:100px;"> 数量 </th>
        <th style="width:200px;"> 领取人</th>
        <th style="width:200px;">领取日期</th>
