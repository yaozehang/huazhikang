...
<div class="content">
  <div class="list-title-all border-bottom">
     <el-button class="title-btn" type="text">职业病防护设施一览表</el-button>
  </div>
  <div class="tableForm">
  ...
  <div class="my-table" >
    ...
    <tbody>
       <tr>
        <th style="width:170px;">  防护设施名称 </th>
        <th style="width:80px;"> 型号 </th>
        <th style="width:480px;">  使用车间和岗位 </th>
        <th style="width:400px;"> 防护用途</th>
        <th style="width:210px;"> 生产及安装单位 </th>
        <th style="width:200px;"> 验收日期</th>
